...
```
cd existing_repo
git remote add origin https://gitlab.com/srirams3/cloud-nurani-srirams.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/srirams3/cloud-nurani-srirams/-/settings/integrations)
